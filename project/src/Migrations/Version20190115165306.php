 ...
 */
final class Version20190115165306 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE genre (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, seo VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, win_competitor_id INT DEFAULT NULL, event_id INT NOT NULL, comp1_id INT NOT NULL, comp2_id INT NOT NULL, date DATETIME NOT NULL, is_bo TINYINT(1) NOT NULL, rounds INT NOT NULL, is_closed TINYINT(1) NOT NULL, is_finished TINYINT(1) NOT NULL, is_draw TINYINT(1) NOT NULL, score1 INT NOT NULL, score2 INT NOT NULL, winner INT NOT NULL, INDEX IDX_7A5BC505C0F070A6 (win_competitor_id), INDEX IDX_7A5BC50571F7E88B (event_id), INDEX IDX_7A5BC505DA973B90 (comp1_id), INDEX IDX_7A5BC505C822947E (comp2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC505C0F070A6 FOREIGN KEY (win_competitor_id) REFERENCES competitor (id)');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC50571F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC505DA973B90 FOREIGN KEY (comp1_id) REFERENCES competitor (id)');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC505C822947E FOREIGN KEY (comp2_id) REFERENCES competitor (id)');
        $this->addSql('ALTER TABLE bet ADD CONSTRAINT FK_FBF0EC9BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE bet ADD CONSTRAINT FK_FBF0EC9B3965E575 FOREIGN KEY (matchup_id) REFERENCES `match` (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `match` DROP FOREIGN KEY FK_7A5BC505C0F070A6');
        $this->addSql('ALTER TABLE `match` DROP FOREIGN KEY FK_7A5BC505DA973B90');
        $this->addSql('ALTER TABLE `match` DROP FOREIGN KEY FK_7A5BC505C822947E');
