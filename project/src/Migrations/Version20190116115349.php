 ...
 */
final class Version20190116115349 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE genre ADD acronym VARCHAR(15) NOT NULL');
        $this->addSql('ALTER TABLE `match` CHANGE win_competitor_id win_competitor_id INT DEFAULT NULL, CHANGE date date DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE date_start date_start DATETIME NOT NULL, CHANGE date_end date_end DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE genre DROP acronym');
        $this->addSql('ALTER TABLE `match` CHANGE win_competitor_id win_competitor_id INT DEFAULT NULL, CHANGE date date DATETIME NOT NULL');
