 ...
 */
final class Version20190123153746 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON NOT NULL, CHANGE token_email token_email VARCHAR(255) DEFAULT NULL, CHANGE token_password token_password VARCHAR(255) DEFAULT NULL, CHANGE date_last_cx date_last_cx DATETIME DEFAULT NULL, CHANGE username displayed_name VARCHAR(255) NOT NULL');
