 ...
 */
final class Version20190129143648 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ban ADD admin_id INT NOT NULL, CHANGE date date DATETIME NOT NULL, CHANGE date_lift date_lift DATETIME NOT NULL');
        $this->addSql('ALTER TABLE ban ADD CONSTRAINT FK_62FED0E5642B8210 FOREIGN KEY (admin_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_62FED0E5642B8210 ON ban (admin_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ban DROP FOREIGN KEY FK_62FED0E5642B8210');
        $this->addSql('DROP INDEX IDX_62FED0E5642B8210 ON ban');
        $this->addSql('ALTER TABLE ban DROP admin_id, CHANGE date date DATETIME NOT NULL, CHANGE date_lift date_lift DATETIME NOT NULL');
